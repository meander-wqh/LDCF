objects = test.o compactedLDCF.o cuckoofilter.o hashfunction.o uint.o
...
compactedLDCF.o: src/compactedLDCF.cpp src/compactedLDCF.h src/uint.h 
	g++ -Wall -c src/compactedLDCF.cpp -lssl -lcrypto

test.o: src/test.cpp src/compactedLDCF.h
	g++ -Wall -c src/test.cpp -lssl -lcrypto

uint.o: src/uint.cpp src/uint.h
	g++ -Wall -c src/uint.cpp -lssl -lcrypto
